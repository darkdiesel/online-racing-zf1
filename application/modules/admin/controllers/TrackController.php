...
class Admin_TrackController extends App_Controller_LoaderController {
	...
	public function init() {
		parent::init();
		$this->view->headTitle($this->view->translate('Трэки'));
	}
	...
	public function allAction() {
		...
		$this->view->pageTitle($this->view->translate('Трэки'));
		...
		$paginator = $this->db->get("track")->getAll(FALSE, "all", "ASC", TRUE, $pager_args);
			...
			$this->messages->addError("{$this->view->translate('Запрашиваемые трэки на сайте не найдены!')}");
		}
	}
