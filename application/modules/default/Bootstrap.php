...
class Default_Bootstrap extends Zend_Application_Module_Bootstrap
{
    ...
    public function _initRoutes()
    {
        ...
        $router->addRoute(
            'defaultLeagueID',
            new Zend_Controller_Router_Route_Regex('league/(\d+)/page/(\d+)\.html',
                array(
                    'module' => 'default',
                    'controller' => 'league',
                    'action' => 'id',
        ...
        $router->addRoute(
            'defaultChampionshipID', new Zend_Controller_Router_Route_Regex('championship/(\d+)\.html', array(
                    'module' => 'default',
        ...
        $router->addRoute(
            'defaultRaceEventID',
            new Zend_Controller_Router_Route_Regex('race-event/(\d+)\.html',
                array(
                    'module' => 'default',
