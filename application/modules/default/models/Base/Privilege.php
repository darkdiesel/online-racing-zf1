...
Doctrine_Manager::getInstance()->bindComponent('Default_Model_Privilege', 'default');

/**
 * Default_Model_Base_Privilege
 * 
 ...
 */
abstract class Default_Model_Base_Privilege extends Doctrine_Record
{
