...
Doctrine_Manager::getInstance()->bindComponent('Default_Model_ResourcesAccess', 'default');

/**
 * Default_Model_Base_ResourcesAccess
 * 
 ...
 */
abstract class Default_Model_Base_ResourcesAccess extends Doctrine_Record
{
