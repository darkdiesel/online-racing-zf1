...
Doctrine_Manager::getInstance()->bindComponent('Application_Model_ResourcesAccess', 'default');

/**
 * Application_Model_BaseResourcesAccess
 * 
 ...
 */
abstract class Application_Model_BaseResourcesAccess extends Doctrine_Record
{
