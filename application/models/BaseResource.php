...
Doctrine_Manager::getInstance()->bindComponent('Application_Model_Resource', 'default');

/**
 * Application_Model_BaseResource
 * 
 ...
 * @property integer $parent_resource_id
 ...
 */
abstract class Application_Model_BaseResource extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('parent_resource_id', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => false,
