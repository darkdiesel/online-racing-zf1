...
Doctrine_Manager::getInstance()->bindComponent('Application_Model_Privilege', 'default');

/**
 * Application_Model_BasePrivilege
 * 
 ...
 */
abstract class Application_Model_BasePrivilege extends Doctrine_Record
{
