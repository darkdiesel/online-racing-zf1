...
Doctrine_Manager::getInstance()->bindComponent('Model_Post', 'doctrine');
 ...
 * @property Model_ContentType $ContentType
 * @property Model_PostType $PostType
 ...
 */
abstract class Model_BasePost extends Doctrine_Record
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Model_ContentType as ContentType', array(
             'local' => 'content_type_id',
             'foreign' => 'id'));

        $this->hasOne('Model_PostType as PostType', array(
             'local' => 'post_type_id',
             'foreign' => 'id'));

        $this->hasMany('Model_Championship as Championship', array(
             'local' => 'id',
             'foreign' => 'rule_id'));

        $this->hasMany('Model_Championship as Championship_4', array(
             'local' => 'id',
             'foreign' => 'game_id'));
    }
}