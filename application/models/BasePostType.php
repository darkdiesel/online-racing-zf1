...
Doctrine_Manager::getInstance()->bindComponent('Application_Model_PostType', 'default');

/**
 * Application_Model_BasePostType
 * 
 ...
 */
abstract class Application_Model_BasePostType extends Doctrine_Record
{
