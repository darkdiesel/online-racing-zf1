...
Doctrine_Manager::getInstance()->bindComponent('Application_Model_Comment', 'default');

/**
 * Application_Model_BaseComment
 * 
 ...
 */
abstract class Application_Model_BaseComment extends Doctrine_Record
{
