...
Doctrine_Manager::getInstance()->bindComponent('Application_Model_ContentType', 'default');

/**
 * Application_Model_BaseContentType
 * 
 ...
 */
abstract class Application_Model_BaseContentType extends Doctrine_Record
{
