...
Doctrine_Manager::getInstance()->bindComponent('Model_Championship', 'doctrine');

/**
 * Model_BaseChampionship
 * 
 ...
 * @property Model_League $League
 * @property Model_User $User
 * @property Model_Post $Post
 * @property Model_Post $Post_4
 ...
 */
abstract class Model_BaseChampionship extends Doctrine_Record
{
    ...
    {
        parent::setUp();
        $this->hasOne('Model_League as League', array(
             'local' => 'league_id',
             'foreign' => 'id'));
        ...
        $this->hasOne('Model_Post as Post_4', array(
             'local' => 'game_id',
             'foreign' => 'id'));

        $this->hasMany('Model_ChampionshipRace as ChampionshipRace', array(
             'local' => 'id',
             'foreign' => 'championship_id'));

        $this->hasMany('Model_ChampionshipTeam as ChampionshipTeam', array(
             'local' => 'id',
             'foreign' => 'championship_id'));

        $this->hasMany('Model_ChampionshipTeamDriver as ChampionshipTeamDriver', array(
             'local' => 'id',
             'foreign' => 'championship_id'));
    }
}