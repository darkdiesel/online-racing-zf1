...
class Application_Form_Reg_User extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $this->setAttribs(
            array(
                 'class' => 'block-item block-item-form block-item-form-w-400 center-block',
        ...
        $this->addElement(
            'text', 'login', array(
                                  ...
                                  'title'       => $this->translate(
                                      'Длина поля должна быть от 5 до 20 символов, содержать только латинские буквы, цифпы и символы -_.'
                                  ),
                                  'required'    => true,
        ...
        $this->addElement(
            'text', 'email', array(
                                  ...
                                  'placeholder' => 'E-mail',
                                  'title'       => $this->translate(
                                      'Поле должно содержать правильный адрес вашего электронного почтового ящика. Пример: example@mail.com.'
                                  ),
                                  'required'    => true,
                                  'class'       => 'form-control tooltip-field',
                                  'filters'     => array('StripTags', 'StringTrim', 'StringToLower'),
        ...
        $this->addElement(
            'password', 'password', array(
                                         ...
                                         'title'       => $this->translate(
                                             'Длина поля должна быть от 6 до 25 символов, содержать только латиские буквы, цифры и символы -_.'
                                         ),
                                         'required'    => true,
                                         'class'       => 'form-control tooltip-field',
        ...
        $this->addElement(
            'password', 'confirmpassword', array(
                                                ...
                                                'title'       => $this->translate(
                                                    'Значение поля должно совпадать со значеним предыдущего поля.'
                                                ),
                                                'AllowEmpty'  => false,
                                                'class'       => 'form-control tooltip-field',
                                                'filters'     => array('StripTags', 'StringTrim'),
        ...
        $this->addElement(
            new Zend_Form_Element_Captcha('captcha', array(
                                                          ...
                                                          'captcha'        => array(
                                                              ...
                                                              // для получения ключей, нужно зарегистроваться
        ...
        $csrfToken = new Zend_Form_Element_Hash('default_reg_user_csrf_token');
