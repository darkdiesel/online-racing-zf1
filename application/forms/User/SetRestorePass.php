...
class Application_Form_User_SetRestorePass extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement(
            'text', 'email', array(
                                  ...
                                  'title'       => $this->translate(
                                      'Введи e-mail адрес, на который зарегестрирован ваш пользователь.'
                                  ),
                                  'required'    => true,
        ...
        $this->addElement(
            'text', 'code_restore', array(
                                         'label'       => $this->translate('Код восстановления'),
                                         'placeholder' => $this->translate('Код восстановления'),
                                         'title'       => $this->translate(
                                             'Введи код восстановления высланный вам для подтверждения на e-mail.'
                                         ),
                                         'required'    => true,
                                         'AllowEmpty'  => false,
                                         'class'       => 'form-control tooltip-field',
        ...
        $csrfToken = new Zend_Form_Element_Hash('default_user_set_restore_pass_csrf_token');
