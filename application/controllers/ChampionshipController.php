    ...
    public function teamAddAction() {
        ...
        if ($league_data) {
            ...
            if ($championship_data) {
                ...
                $form->setAction($this->view->url(array('controller' => 'championship', 'action' => 'team-add', 'league_id' => $league_id, 'championship_id' => $championship_id), 'championship', true));
                $this->view->form = $form;
                ...
                if ($this->getRequest()->isPost()) {
                    if ($form->isValid($request->getPost())) {
                        ...
                        $this->redirect($this->view->url(array('controller' => 'championship', 'action' => 'id', 'league_id' => $league_id, 'championship_id' => $championship_id), 'championship', true));
                    } else {
                        $this->messageManager->addError($this->view->translate('Исправьте следующие ошибки для корректного завершения операции!'));
                    }
                }
        ...
        if ($league_data) {
            ...
            if ($championship_data) {
                ...
                if ($championship_team_data) {
                    ...
                    $form->setAction($this->view->url(array('controller' => 'championship', 'action' => 'team-edit', 'league_id' => $league_id, 'championship_id' => $championship_id, 'team_id' => $team_id), 'championshipTeam', true));
        ...
        if ($league_data) {
            ...
            if ($championship_data) {
                ...
                if ($championship_team_data) {
                    ...
                    //error message if team in the championship not found
                    $this->messageManager->addInfo("{$this->view->translate("В чемпионате <strong>\"{$championship_data->name}\"</strong> нет команд!")}");
                    //head title
            ...
            if ($championship_data) {
                ...
                if ($championship_team_data) {
                    ...
                    if ($championship_team_driver_data) {
                        ...
                        $form->setAction($this->view->url(array('controller' => 'championship', 'action' => 'driver-delete', 'league_id' => $league_id, 'championship_id' => $championship_id, 'team_id' => $team_id, 'user_id' => $user_id), 'championshipTeamDriver', true));
                        $form->cancel->setAttrib('onClick', "location.href=\"{$this->view->url(array('controller' => 'championship', 'action' => 'team-show', 'league_id' => $league_id, 'championship_id' => $championship_id, 'team_id' => $team_id), 'championshipTeam', true)}\"");
            ...
            if ($championship_data) {
                ...
                if ($championship_team_data) {
                    ...
                    if ($championship_team_driver_data) {
                        ...
                        $form->setAction($this->view->url(array('controller' => 'championship', 'action' => 'driver-edit', 'league_id' => $league_id, 'championship_id' => $championship_id, 'team_id' => $team_id, 'user_id' => $user_id), 'championshipTeamDriver', true));
                        $form->cancel->setAttrib('onClick', "location.href=\"{$this->view->url(array('controller' => 'championship', 'action' => 'team-show', 'league_id' => $league_id, 'championship_id' => $championship_id, 'team_id' => $team_id), 'championshipTeam', true)}\"");
