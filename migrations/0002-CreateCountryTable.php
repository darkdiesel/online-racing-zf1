    ...
    function up()
    {
        $sql = " 
                CREATE TABLE IF NOT EXISTS `country` (
                    ...
                    `UrlImageRound` varchar(255) NOT NULL,
                    `UrlImageGlossyWave` varchar(255) NOT NULL,
                    `date_create` datetime NOT NULL,
                    `date_edit` datetime NOT NULL,
                    PRIMARY KEY  (`id`)
                  ) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11 ;
                  
                INSERT INTO `country` (`id`, `name`, `abbreviation`, `UrlImageRound`, `UrlImageGlossyWave`, `date_create`, `date_edit`) VALUES
