    ...
    function up()
    {
        $sql = " 
                CREATE TABLE IF NOT EXISTS `country` (
                    ...
                    `url_image_round` varchar(255) NOT NULL,
                    `url_image_glossy_wave` varchar(255) NOT NULL,
                    `date_create` datetime NOT NULL,
                    `date_edit` datetime NOT NULL,
                    PRIMARY KEY  (`id`)
                  ) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11 ;
                  
                INSERT INTO `country` (`id`, `name`, `abbreviation`, `url_image_round`, `url_image_glossy_wave`, `date_create`, `date_edit`) VALUES
