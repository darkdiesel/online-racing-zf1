...
class CreateArticleTable extends Akrabat_Db_Schema_AbstractChange {
    ...
    function up() {
        ...
        $sql = " CREATE TABLE IF NOT EXISTS `article` (
                 ...
                 ALTER TABLE `article`
                    ADD CONSTRAINT `article_ibfk_3` FOREIGN KEY (`content_type_id`) REFERENCES `content_type` (`id`),
                    ADD CONSTRAINT `article_ibfk_2` FOREIGN KEY (`article_type_id`) REFERENCES `article_type` (`id`),
