...
(function($) {
	...
	$sk.fn.extend({
		...
		setup: function() 
		{
			...
			{
				// New animation
				self.settings.animateNumberOut = {opacity:0};
		...
		{
			var self = this;
			this.box_skitter.find('.image_number_select').css({backgroundColor: '#333', opacity:1}).removeClass('image_number_select');
			$('#image_n_'+(this.settings.image_i+1)+'_'+self.number_skitter).css({backgroundColor: '#cc3333',opacity:1}).addClass('image_number_select');
		},
