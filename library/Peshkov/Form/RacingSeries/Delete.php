...
class Peshkov_Form_RacingSeries_Delete extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $adminRacingSeriesDeleteUrl = $this->getView()->url(
            array('module' => 'admin', 'controller' => 'racing-series', 'action' => 'delete', 'racingSeriesID' => $request->getParam('racingSeriesID')),
        ...
        $this->setAttribs(
            array(
                ...
                'id' => 'racing-series-delete'
            )
        )
            ->setName('racingSeriesDelete')
            ->setAction($adminRacingSeriesDeleteUrl)
            ->setMethod('post')
        ...
        $cancel->setLabel($this->translate('Отмена'))
            ->setAttrib('onClick', "location.href='{$adminRacingSeriesIDUrl}'")
