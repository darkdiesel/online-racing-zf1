...
Doctrine_Manager::getInstance()->bindComponent('Peshkov_Model_Comment', 'doctrine');

/**
 * Peshkov_Model_BaseComment
 * 
 ...
 */
abstract class Peshkov_Model_BaseComment extends Doctrine_Record
{
