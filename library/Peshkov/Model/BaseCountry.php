...
Doctrine_Manager::getInstance()->bindComponent('Peshkov_Model_Country', 'doctrine');

/**
 * Peshkov_Model_BaseCountry
 * 
 ...
 */
abstract class Peshkov_Model_BaseCountry extends Doctrine_Record
{
    ...
    {
        parent::setUp();
        $this->hasMany('Peshkov_Model_User as User', array(
             'local' => 'ID',
             'foreign' => 'country_id'));
    }
}