...
Doctrine_Manager::getInstance()->bindComponent('Peshkov_Model_ResourcesAccess', 'doctrine');

/**
 * Peshkov_Model_BaseResourcesAccess
 * 
 ...
 */
abstract class Peshkov_Model_BaseResourcesAccess extends Doctrine_Record
{
